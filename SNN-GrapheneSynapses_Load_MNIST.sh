...
#PBS -P JCU-SNN
#PBS -o /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/MNISTDataLoader_out.txt
#PBS -e /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/MNISTDataLoader_error.txt
#PBS -q Short
