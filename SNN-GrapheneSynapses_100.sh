#!/bin/bash
### qstat -f -Q
#PBS -N SNN-GrapheneSynapses_Optimization_100
#PBS -P JCU-SNN
#PBS -o /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_100_out.txt
#PBS -e /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_100_error.txt
#PBS -q Single
