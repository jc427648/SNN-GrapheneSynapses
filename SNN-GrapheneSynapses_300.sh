...
#PBS -P JCU-SNN
#PBS -o /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_300_out.txt
#PBS -e /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_300_error.txt
#PBS -q Single
