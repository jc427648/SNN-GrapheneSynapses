...
#PBS -P JCU-SNN
#PBS -o /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_10_out.txt
#PBS -e /scratch/user/coreylammie/SNN-GrapheneSynapses/logs/SNN-GrapheneSynapses_Optimization_10_error.txt
#PBS -q Single
