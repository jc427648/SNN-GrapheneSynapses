...
VthMax = 20e-4;
Ve = 0.2e-4;
tau = 0.030e-3; % Timing constant
R = 1e3; % Membrane resistance
dt = 0.0002; % Timestep (s)
T = 0:dt:1; % Simulation timesteps
...
refPer = 0.10;%Refractory period (s).
...
init_w = 0 / 1 + (Imax) / 1 .* rand(5, 5, num_neurons); %Make random currents between zero and Imax.
